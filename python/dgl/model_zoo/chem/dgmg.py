...
import paddorch.nn.init as init
from paddorch.distributions import Categorical
...
class ChooseDestAndUpdate(nn.Module):
    ...
    def _initialize_edge_repr(self, g, src_list, dest_list, edge_embed):
        ...
        """
        g.edges[src_list, dest_list].data['he'] = torch.expand(edge_embed, [len(src_list), -1])
